...
public class GFXAppearances {
    ...
    private void SetAppearances() {
        defs = new Appearance[]
                {createTerrainAppearance("VOID", 4, 5),
                        ...
                        createBigAppearance("PRELUDE_DRACULA", configuration.IMAGE_BIG_MONSTERS, 4,
                                5),
                        ...
                        /* Alchemy Lab */
                        createTerrainAppearance("RED_FLOOR", 3, 5), createTerrainAppearance("RED_WALL", 1, 5),
                        ...
                        /* Void */
                        createTerrainAppearance("VOID_STAR", 1, 9), createTerrainAppearance("VOID_SUN", 2, 9),
